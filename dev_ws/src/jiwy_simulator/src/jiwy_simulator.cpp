...
#include "rtsd_interfaces/msg/point2.hpp" // 2D point (x and y coordinates)
...
class JiwySimulator : public rclcpp::Node
{
  ...
  private:
    ...
    rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr webcam_output_topic_;
    rclcpp::Subscription<rtsd_interfaces::msg::Point2>::SharedPtr setpoint_topic_;
    rclcpp::Publisher<rtsd_interfaces::msg::Point2>::SharedPtr position_topic_;
    ...
    void create_topics()
    {
      ...
      webcam_output_topic_ = this->create_publisher<sensor_msgs::msg::Image>("webcam_output", 1);
      setpoint_topic_ = this->create_subscription<rtsd_interfaces::msg::Point2>(
        "setpoint", 10, std::bind(&JiwySimulator::setpoint_topic_callback, this, _1));
      position_topic_ = this->create_publisher<rtsd_interfaces::msg::Point2>("position",1);
    }
    ...
    void webcam_topic_callback(const sensor_msgs::msg::Image::SharedPtr msg) 
    {
      ...
      webcam_output_topic_->publish(output_image_);
    }
    ...
    void setpoint_topic_callback(const rtsd_interfaces::msg::Point2::SharedPtr msg) 
    {
    ...
    void dynamics_timer_callback()
    {
      ...
      rtsd_interfaces::msg::Point2 pos;
